...
knitr::kable(table_combined, format = 'markdown', caption = 'Bias and coverage of all models. Mean and standard deviation bias is calculated from the distance between the point estimate and simulated value. Coverage is the proportion of times that the simulated value was withing the point estimate +- 2SE.')
```
